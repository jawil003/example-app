...
const Home: NextPage = () => {
  return (
    <>
      ...
      <Header>
        <Navigation />
        <div className="mt-10 mx-auto px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28 h-full">
          <div className="flex flex-col md:flex-row w-full items-start justify-between md:justify-start h-full md:h-1/2">
            <div className="text-left z-20 md:z-30 w-full md:w-1/2 flex flex-col items-center md:items-start justify-start md:justify-center h-full">
              <h1 className="tracking-tight font-extrabold text-gray-900 titleHome text-6xl ">
                <span className="flex w-full m-auto text-navy-600">
                  Tail-kit
                </span>
            ...
            <div className="opacity-10 z-10 md:z-50 md:opacity-70 sm:text-center absolute lg:text-left transform  w-full -right-10 -top-72  md:w-1/2">
              <div className="flex gap-4 gap-y-1">
                    ...
                    <div className="overflow-hidden shadow-lg rounded-2xl h-90 w-64  m-auto">
                      ...
                      <div className="bg-white w-full p-4 relative">
                        <button
                          ...
                          type="button"
                          className="absolute rounded-full bg-navy-500 text-white w-12 h-12 right-8 -top-6"
                        >
                          <svg
                            width="20"
                            height="20"
                      ...
                      <div className="w-full h-full text-center">
                        <div className="flex h-full flex-col justify-between">
                          <svg
                            width="40"
                            height="40"
                            className="mt-4 w-12 h-12 m-auto text-navy-500"
                            fill="currentColor"
                            viewBox="0 0 1792 1792"
                            xmlns="http://www.w3.org/2000/svg"
                          >
                    ...
                    <div className="shadow-lg rounded-2xl w-64 p-4 bg-white flex justify-between items-center">
                      ...
                      <div className="w-3/6">
                        <p className="text-gray-500 text-sm">
                          You have
                          <span className="text-navy-500 font-bold">2</span>
                          new messages
                        </p>
                      </div>
                      <div className="w-1/6 text-right">
                        <svg
                          ...
                          fill="currentColor"
                          viewBox="0 0 1792 1792"
                          className="text-navy-500 h-6 w-6"
                          xmlns="http://www.w3.org/2000/svg"
                        >
                  ...
                  <div className="mb-4">
                    <div className="w-64">
                      <div className="mt-1 relative">
                        <button
                          type="button"
                          className="relative w-full bg-white rounded-md shadow-lg pl-3 pr-10 py-3 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-navy-500 focus:border-navy-500 sm:text-sm"
                        >
                ...
                <div className="col-1">
                  <div className="mb-4">
                    <div className="shadow-lg rounded-2xl w-64 bg-navy-500 dark:bg-gray-800 p-4">
                      ...
                      <button
                        type="button"
                        className="w-full px-3 py-3 text-sm shadow rounded-lg text-navy-500 bg-white hover:bg-gray-100 "
                      >
                        Choose plan
                      </button>
                    </div>
                        ...
                        <div className="rounded-lg bg-pink-100 dark:bg-white p-2 w-full mb-4">
                          <div className="flex items-center justify-between text-xs text-gray-400 dark:text-black">
                            <p className="flex flex-col">
                              Art.
                              <span className="text-black dark:text-navy-500 font-bold">
                                34
                              </span>
                            </p>
                            <p className="flex flex-col">
